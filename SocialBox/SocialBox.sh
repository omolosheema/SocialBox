...
echo -e "	[+]              $red Coded By julian sparks$nc         		   [+]"
echo -e "	[+] 		 $red www.facebook.com/Juliansparks2020$nc 		   [+]"
echo -e "	[+] 		 $red mobilehackersusa@gmail.com$nc          		   [+]"
echo -e "	[+]$red Special Greetz To$nc :$green {thelinuxchoice , mhackersusa, taipei vsuhackers}$nc [+]"
echo ""
